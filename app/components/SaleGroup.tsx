...
const SaleGroup = ({ item }: { item: TSaleGroups }) => {
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 w-full h-full bg-blue-900 rounded-3xl transform translate-y-2 max-xs:translate-x-1 xs:translate-x-3 shadow-inner-custom"></div>

      {/* Target */}
      <div className="flex items-center bg-card text-blue-500 gap-4 px-4 rounded-3xl py-2 md:py-3 relative z-10">
